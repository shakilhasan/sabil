...
export const userLogin = user =>
    post(url.USER_LOGIN, user, {params : {...user}});
export const userSignup = user =>
    post(url.USER_SIGNUP, user); // todo remove later by /register
...
export const getUserAccount = user =>
    get(url.ACCOUNT_USER, {params : {...user}});
...
export const getSalesOrderById = id =>
    get(url.GET_SALES_ORDER, {params : {id}});
...
//  ....................................
// add user
export const addManyResources = resources =>
    post(url.ADD_MANY_RESOURCES, resources)
